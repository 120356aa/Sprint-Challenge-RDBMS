...
SQL = Structured Query Language, it is a language used to talk to the database.
1. Why do tables need a `primary key`?
They need them to differentiate the data.
1. What is the name given to a table column that references the primary key on another table.
Foreign key.
1. What do we need in order to have a _many to many_ relationship between two tables.
The junction table has to refer to multiple foreign keys, and you must use more than one join statement.
